---
title: "Embedding PackagingTools via .NET SDK"
---
...
- Combine the SDK with the [CI starter templates](../advanced/starter-workflows.md) to author bespoke pipeline steps while reusing the same orchestration core.
