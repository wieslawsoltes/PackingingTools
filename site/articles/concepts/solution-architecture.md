...
- Architecture decision records (ADRs) are tracked in the [reference ADR section](../reference/adr/readme.md) for major decisions such as runtime targeting, persistence, plugin design, and configuration strategy.
